...
import 'package:adams/appointment/homeAppointment.dart';
import 'package:adams/QRHomePage.dart';
...
class _SideNavState extends State<SideNav> {
  ...
  String _userEmail = "";
  String _userUrl =
      'https://res.cloudinary.com/sewwandi/image/upload/v1589990314/upload.png';
    ...
    return Drawer(
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Route route = MaterialPageRoute(builder: (context) => QRHomePage());
            Navigator.push(context, route);
          },
        ),
        ListTile(
